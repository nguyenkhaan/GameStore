...
## Field vs Property 
Both have similar things in uses. But you have to remember how to compare them via syntax and getter/setter
### Field 
**Syntax**: `public string Name;` 
- As you can see, it don't have getter or setter functions. 
- You can set or get its value, but this is a direct set and get value, meaning you direct do assign: `object.Name = "Nguyen Kha An"`


### Property
**Syntax**: `public string Name {get; set;}`
- As you can see, it have {get;} and {set;} in the define. When you do this, this will c# will auto create a getter and setter function for you. 
- You can set or get its value, but this is a set and get via functions (auto-generated by c#). Meaning you will have: object.Name = "Nguyen Kha An" equals object.setName("Nguyen Kha An")
- If you don't have set;, you cannot assign value
- You always have {get;}

## readonly 
- This field cannot be assigned again. 
- Can only use with `field`, not `property`
